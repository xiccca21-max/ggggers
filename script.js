...
class ProjectModal {
    ...
    getProjectFeatures(title, desc, tags) {
        const featureMap = {
            'финансов': ['AI-советник на базе Llama 3.3 70B', 'Мультивалютные счета (₽, $, €, ₿, Ξ, ₮)', 'Финансовый скор и прогноз на 3/6/12 мес.', 'Геймификация: челленджи, достижения и XP', 'Кризисный режим и трекер подписок'],
            'P2P': ['Дашборд с live-графиками дохода и статистикой', 'Управление сделками и апелляциями (С2С / СБП)', 'Кошелёк USDT (TRC-20 / ERC-20 / BEP-20)', 'Реферальная система с аналитикой и промокодами', 'Интеграция с Telegram и Command Palette (Ctrl+K)'],
            ...
            'барбершоп': ['Онлайн-запись к мастеру', 'Галерея работ и стрижек', 'Прайс-лист с актуальными ценами', 'Отзывы клиентов и рейтинг'],
